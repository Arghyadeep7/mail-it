        ...
        <>
          ...
          <div className={styles.container}>
            ...
            <Row style={{ textAlign: "left", marginTop: "3vh" }}>
              ...
              <Col xs={12} className={styles.info}>
                <Row>
                  <Col xs={window.innerWidth<512 && data.msg.length<30?3:12} md={2} lg={1} style={{marginBottom:"10px"}}>
                    <span className={styles.field}>Body</span>
                  </Col>
                  <Col xs={window.innerWidth<512 && data.msg.length<30?9:12} md={10} lg={11} style={{whiteSpace: "pre-wrap"}}>
